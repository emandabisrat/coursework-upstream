...
def check_number(actual, recreate_msg=None):
    ...
    msg = "The function returned a value of the wrong type.\n"
    msg += "  Expected return type: an integer or a float.\n"
    msg += "  Actual return type: {}.".format(actual_type.__name__)
    if recreate_msg is not None:
        msg += "\n" + recreate_msg
...
def check_unmodified(param_name, before, after, recreate_msg=None):
    """
    Generate an error if a data structure was modified when modifications
    are disallowed.
    """
